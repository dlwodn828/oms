...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">회원점핑 쿠폰관리 <small>List</small></h1>
	<!-- end page-header -->
			...
			<table class="table table-bordered table-hover table-td-valign-middle">
				<thead>
					<tr>
						...
						<th width="5%" class="text-center">점핑수</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><a href="/systems/jumpingCouponUseList<?=$sParam?>&Idx=<?=$row->Idx?>"><?=$row->UserCode?></a></td>
						<td class="text-center"><?=fnMemberGrade($row->UserGrade)?></td>
						<td class="text-center"><a href="/systems/jumpingCouponUseList<?=$sParam?>&Idx=<?=$row->Idx?>"><?=$row->UserId?></a></td>
						<td class="text-center"><a href="/systems/jumpingCouponUseList<?=$sParam?>&Idx=<?=$row->Idx?>"><?=$row->UserName?></a></td>
						...
						<td class="text-center"><?=$row->iCnt03?></td>
						<td class="text-center">
							<a href="/systems/jumpingCouponUseList<?=$sParam?>&Idx=<?=$row->Idx?>" class="btn btn-info btn-xs" ><i class="fa fa-eye"></i> View</a>
						</td>
					</tr>
					<? } ?>
				</tbody>
