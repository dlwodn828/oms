		...
		<div class="vertical-box">
					...
					<div class="panel panel-profile">
						<div class="panel-body text-left">
							...
							<ul class="nav nav-pills nav-stacked nav-sm">
								<li><a href="/systems/jumpingCouponUseList<?=$sParam?>"><i class="fa fa-minus-square fa-fw m-r-5"></i> 사용내역 <span class="badge badge-danger pull-right"><?=$arrResult02->iCnt03?></span></a></li>
								<li class="active"><a href="/systems/jumpingCouponIssueList<?=$sParam?>"><i class="fa fa-plus-square fa-fw m-r-5"></i> 발급종류 </a></li>
							</ul>
						</div>
					</div>
					<div class="panel panel-profile">
			...
			<div class="vertical-box-column tab-content">
				...
				<div id="jumping" class="p-0">
					<div class="panel panel-profile">
						<div class="wrapper">
							<h4 class="m-b-15 m-t-0 p-b-10 underline"><i class="fa fa-info-circle m-r-5"></i> 점핑쿠폰 발급종류
								...
								<table class="table table-bordered table-hover table-td-valign-middle table-primary">
									<thead>
										<tr>
											...
											<th class="text-center">발급 내용</th>
											<th width="20%" class="text-center">발급 날짜</th>
											<th width="20%" class="text-center">점핑수</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td class="text-center"><a href="#modal-create" data-toggle="modal" class="editSelect" data-idx="<?=$row->Idx?>"><?=$row->Title?></a></td>
											<td class="text-center"><?=$row->RegDate?></td>
											<td class="text-center"><?=$row->CouponCnt?></td>
										</tr>
										<? } ?>
									</tbody>
								</table>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="panel-body panel-form">
						<form data-parsley-validate="true" class="form-horizontal form-bordered" id="actForm02" action="/systems/jumpingCouponIssueModifyProc" method="POST">
						...
						<input type="hidden" name="sParam" value="<?=$sParam?>">
							...
							<div class="form-group">
								...
								<div class="col-md-2 col-sm-4">
									<input type="number" class="form-control" id="CouponCnt" name="CouponCnt" min="-10" max="10" />
								</div>
							</div>
...
$("#actForm02").submit(function(e) {
	e.preventDefault();
		...
		rules: {
			...
			"CouponCnt": {required:true,number:true,maxlength:11},
		},
		...
		messages: {
			"Title" : {required : "발급내용을 입력해주세요."},
			"CouponCnt" : {required : "점핑수를 입력해주세요."},
		},
...
$(document).on('click','.editSelect', function (e) {
	$.ajax({
	url:"/systems/jumpingCouponIssueModify?Idx="+$(this).data("idx"),
	dataType:"json",
	}).done(function (data) {
		$("#CouponIdx").val(data.Idx);
		$("#Title").val(data.Title);
		$("#CouponCnt").val(data.CouponCnt);
		sSendFlag02=true;
	}).fail(function () {
	});
});
