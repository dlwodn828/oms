...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">탈퇴회원 현황 <small>List</small></h1>
	<!-- end page-header -->
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-hover table-td-valign-middle">
				<thead>
					<tr>
						...
						<th width="5%" class="text-center">탈퇴일</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><a href="/systems/withdrawmemberView<?=$sParam?>&Idx=<?=$row->Idx?>"><?=$row->UserCode?></a></td>
						<td class="text-center"><?=fnMemberGrade($row->UserGrade)?></td>
						<td class="text-center"><a href="/systems/withdrawmemberView<?=$sParam?>&Idx=<?=$row->Idx?>"><?=$row->UserId?></a></td>
						<td class="text-center"><a href="/systems/withdrawmemberView<?=$sParam?>&Idx=<?=$row->Idx?>">회원이름</a></td>
						...
						<td class="text-center"><?=$row->DelDate?></td>
						<td class="text-center">
							<a href="/systems/withdrawmemberView<?=$sParam?>&Idx=<?=$row->Idx?>" class="btn btn-info btn-xs" ><i class="fa fa-eye"></i> View</a>
						</td>
					</tr>
					<? } ?>
				</tbody>
			...
			<div class="panel-body">
				<div class="dataTables_info" id="data-table_info">
					<a href="/systems/withdrawMemberListExcel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
				</div>
