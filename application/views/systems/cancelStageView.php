...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">대기(취소자) 스테이지 관리 <small>View</small></h1>
	<!-- end page-header -->
		...
		<div class="vertical-box">
			<div class="vertical-box-column width-300">
				...
				<div class="wrapper">
					...
					<div class="text-left">
						<a href="/systems/cancelStageList<?=$sParam02?>" class="btn btn-primary btn-xs"><i class="fa fa-list"></i> Go List</a>
					</div>
				</div>
				<!-- end wrapper -->
			</div>
					...
					<div class="panel panel-profile">
						<div class="wrapper">
							<h4 class="m-b-15 m-t-0 p-b-10 underline"><i class="fa fa-info-circle m-r-5"></i> 스테이지 기본 정보
								<a href="/systems/cancelStageList<?=$sParam02?>" class="btn btn-primary btn-xs pull-right"><i class="fa fa-list"></i> Go List</a>
							</h4>
