...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">약관 관리 <small>Create</small></h1>
	<!-- end page-header -->
	<div class="profile-container">
		<div class="panel-body panel-form">
			<form class="form-horizontal form-bordered form-custom" data-parsley-validate="true" id="actForm" name="actForm" action="/settings/agreementCreateProc" method="POST">
			...
			<input type="hidden" name="sParam" value="<?=$sParam?>">
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3"><a href="/settings/agreementList<?=$sParam?>" class="btn btn-primary btn-xs"><i class="fa fa-list"></i> Go List</a></label>
					<div class="col-md-6 col-sm-6 m-t-10 text-center">
						...
						<a href="/settings/agreementList<?=$sParam?>" class="btn btn-warning btn-xs"><i class="fa fa-ban"></i> Cancel</a>
					</div>
				</div>
			</form>
		</div>
