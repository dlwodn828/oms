					...
					<table class="table table-bordered table-hover table-td-valign-middle">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><?=$row["plated"]?></td>
								<td class="text-center"><?=$row["setnumber"]?></td>
								<td class="text-center "><form action="/orders/modifyOrder" method="post"><button name="idx" value="<?=$row["idx"]?>" class="btn btn-warning btn-sm modify" type="submit">수정</button></form></td>
