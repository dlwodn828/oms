...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">대기 순번별 평균 대기일- 5명 <small>Statistics</small></h1>
	<!-- end page-header -->
			...
			<div class="col-md-12 p-15">
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/waitTermStatistics5Excel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
			</div>
		</div>
