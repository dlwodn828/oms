...
<div id="content" class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="active">순번별 연체인원 - 13명 </li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">순번별 연체인원 - 13명 <small>Statistics</small></h1>
	<!-- end page-header -->
			...
			<div class="col-md-12 p-15">
				<table class="table table-bordered table-hover table-td-valign-middle">
					...
					<tr>
						...
						<th colspan="13" class="text-center">순번</th>
					...
					<tr>
						...
						<th width="8%" class="text-center">11</th>
						<th width="8%" class="text-center">12</th>
						<th width="8%" class="text-center">13</th>
					</tr>
					</thead>
					<tbody>
						<?
						...
						<tr>
							...
							<td class="text-center valign-middle"><span class="text-warning f-s-13 f-w-500"><?=$arrTotalCnt[10]?> (<?=$arrCnt03[10]?>%)</span></td>
							<td class="text-center valign-middle"><span class="text-warning f-s-13 f-w-500"><?=$arrTotalCnt[11]?> (<?=$arrCnt03[11]?>%)</span></td>
							<td class="text-center valign-middle"><span class="text-warning f-s-13 f-w-500"><?=$arrTotalCnt[12]?> (<?=$arrCnt03[12]?>%)</span></td>
							<td class="text-center valign-middle"><span class="text-warning f-s-13 f-w-500"><?=$arrTotalCnt[13]?> (<?=$arrCnt03[13]?>%)</span></td>
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/overdueTermStatistics13Excel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
