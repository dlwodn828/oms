...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">일별 통계 (스테이지) <small>Statistics</small></h1>
	<!-- end page-header -->
	<!-- end page-header -->
	<div class="profile-container">
		<div class="table-responsive">
			...
			<div class="col-md-12">
				<ul class="nav nav-pills m-l-20 m-t-20">
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="default-pills-tab-1">
						...
						<div class="panel-body">
							<div class="dataTables_info">
								<a href="/statistics/dayStageStatisticsExcel01<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
							</div>
						</div>
					</div>
					<div class="tab-pane fade active in" id="default-pills-tab-2">
						...
						<div class="panel-body">
							<div class="dataTables_info">
								<a href="/statistics/dayStageStatisticsExcel02<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
							</div>
						</div>
					</div>
...
<script src="/assets/js/statistics-activity-day.stage.js"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
<script>
$(document).ready(function() {
	...
	*/
	...
	StatisticsActivityDayStage.init(options, options2);
