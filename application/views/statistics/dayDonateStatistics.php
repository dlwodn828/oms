...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">일별 통계(나눔) <small>Statistics</small></h1>
	<!-- end page-header -->
	<!-- end page-header -->
			...
			<div class="col-md-12">
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/dayDonateStatisticsExcel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
			</div>
		</div>
...
<script src="/assets/js/statistics-activity-day.donate.js"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
<script>
$(document).ready(function() {
	...
	*/
	...
	StatisticsActivityDayDonate.init(options);
});
</script>