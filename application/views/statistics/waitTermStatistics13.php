...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">대기 순번별 평균 대기일- 13명 <small>Statistics</small></h1>
	<!-- end page-header -->
			...
			<div class="col-md-12 p-15">
				<table class="table table-bordered table-hover table-td-valign-middle">
					...
					<tr>
						...
						<th width="12%" class="text-center">10</th>
						<th width="12%" class="text-center">11</th>
						<th width="12%" class="text-center">12</th>
						<th width="12%" class="text-center">13</th>
					</tr>
					</thead>
					<tbody>
						<?
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/waitTermStatistics13Excel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
