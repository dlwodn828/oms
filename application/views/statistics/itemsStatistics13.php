...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header"> 인원  - 13명 <small>Statistics</small></h1>
	<!-- end page-header -->
			...
			<div class="col-md-12">
						...
						<? for ($iCnt=7;$iCnt<18;$iCnt++) {
							for ($iCnt02=0;$iCnt02<sizeof($arrDate04);$iCnt02++) {
								if ($iCnt==$arrDate04[$iCnt02]["StageRate"]) {
									$iCnt03=$arrDate04[$iCnt02]["StageMoney"]/130;
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/itemsStatistics13Excel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
			</div>
		</div>
