...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header"> 인원  - 9명 <small>Statistics</small></h1>
	<!-- end page-header -->
	<!-- end page-header -->
			...
			<div class="col-md-12">
						...
						<? for ($iCnt=8;$iCnt<21;$iCnt++) {
							for ($iCnt02=0;$iCnt02<sizeof($arrDate04);$iCnt02++) {
								if ($iCnt==$arrDate04[$iCnt02]["StageRate"]) {
									$iCnt03=$arrDate04[$iCnt02]["StageMoney"]/90;
				...
				<div class="panel-body">
					<div class="dataTables_info">
						<a href="/statistics/itemsStatistics9Excel<?=$sParam?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> Excel </a>
					</div>
				</div>
			</div>
		</div>
