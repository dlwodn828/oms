		...
		<div class="login login-with-news-feed">
			...
			<div class="news-feed">
				...
				<div class="news-caption">
					<h4 class="caption-title"><i class="fa fa-diamond text-success"></i> <?=sSiteName?></h4>
				</div>
			</div>
			<!-- end news-feed -->
			<!-- begin right-content -->
			<div class="right-content">
				...
				<div class="login-header">
					<div class="brand">
						<span class="logo"></span> WMS Admin
					</div>
					<div class="icon">
				...
				<div class="login-content">
					<form id="actForm" action="/auth/loginProc" method="POST" class="margin-bottom-0">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name()?>" value="<?=$this->security->get_csrf_hash()?>" />
						<div class="form-group m-b-15">
							<input type="text" id="AdminId" name="AdminId" value='<?=$AdminId?>' class="form-control input-lg" placeholder="ID" />
						</div>
						<div class="form-group m-b-15">
							<input type="password" id="AdminPwd" name="AdminPwd" class="form-control input-lg" placeholder="PASSWORD" />
						</div>
						<div class="login-buttons">
							<button type="submit" class="btn btn-primary btn-block btn-lg">Sign me in</button>
						</div>
						<div class="m-t-20 m-b-40 p-b-40">
							※ 접속정보를 모르신다면 관리자에게 문의주세요.
						</div>
						<hr />
						<p class="text-center text-inverse">
							copyright &copy; by WMS All Right Reserved
						</p>
					</form>
				</div>
				<!-- end login-content -->
